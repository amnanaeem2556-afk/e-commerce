      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex-1 flex items-center justify-center min-w-0 px-1">
          <button
            ...
            className="flex items-center justify-center gap-1.5 sm:gap-2 tracking-wide font-medium hover:text-[#C48A5A] transition-colors focus:outline-none group cursor-pointer max-w-full"
          >
            <IconComponent className="w-3.5 h-3.5 text-[#C48A5A] shrink-0" />
            <span className="text-[11px] sm:text-xs text-center line-clamp-1 break-words">{active.text}</span>
            <span className="text-[10px] text-[#E7D6C1] underline decoration-[#C48A5A]/50 group-hover:decoration-[#C48A5A] hidden sm:inline-flex items-center shrink-0">
