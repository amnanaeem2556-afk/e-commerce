  ...
  return (
    <footer className="bg-[#2B1D17] text-[#FAF6F0] border-t border-[#6B4A3A]/40 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Trust Badges Strip */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 pb-12 sm:pb-14 border-b border-[#6B4A3A]/50">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <h4 className="font-sans text-xs sm:text-sm font-semibold tracking-wide">Master Craftsmanship</h4>
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <h4 className="font-sans text-xs sm:text-sm font-semibold tracking-wide">White Glove Delivery</h4>
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <h4 className="font-sans text-xs sm:text-sm font-semibold tracking-wide">30-Day In-Home Trial</h4>
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <h4 className="font-sans text-xs sm:text-sm font-semibold tracking-wide">Secured Checkout</h4>
        ...
        <div className="py-12 border-b border-[#6B4A3A]/50 max-w-2xl mx-auto text-center">
          ...
          <h3 className="font-heading text-2xl sm:text-3xl tracking-[0.03em] leading-none mt-1 mb-2 text-[#FAF6F0]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-10 py-12 border-b border-[#6B4A3A]/50 text-xs">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            >
              <span className="font-heading text-3xl sm:text-4xl tracking-[0.22em] text-[#FAF6F0] leading-none">
                LUMORA
              </span>
              <p className="text-[8.5px] tracking-[0.32em] text-[#C48A5A] uppercase font-semibold mt-0.5">
                HAUTE COUTURE
              </p>
            </button>
            <p className="text-xs text-[#E7D6C1]/90 leading-relaxed font-normal pr-6">
          ...
          <div className="space-y-3">
            <h5 className="font-sans text-xs font-semibold uppercase tracking-widest text-[#C48A5A]">
              Collections
            </h5>
